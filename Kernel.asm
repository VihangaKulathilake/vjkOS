; ==================================================================
; vjkOS -- An Operating System kernel written in Assembly
; by Vihanga Kulathilake. This OS is inspired by MikeOS. Great thanks
...
welcome_string      db '_        _  ______   _   _ ', 0Dh, 0Ah
                    db '\ \    / / |_    _| | | / /', 0Dh, 0Ah
                    db ' \ \  / /     | |   | |/ / ', 0Dh, 0Ah
                    db '  \ \/ /   _  | |   |   <  ', 0Dh, 0Ah
                    db '   \  /   | |_| |   | |\ \ ', 0Dh, 0Ah
                    db '    \/     \____|   |_| \_\', 0Dh, 0Ah
                    db '                     ', 0Dh, 0Ah
                    db 'Welcome to vjkOS by Vihanga Kulathilake!', 0Dh, 0Ah, 'Basic commands: info, help, clear', 0
prompt_string       db 'vjkOS :) >> ', 0
unknown_cmd_string  db 'Unknown command', 0
info_cmd            db 'info', 0
help_cmd            db 'help', 0           
clear_cmd           db 'clear', 0          
help_menu_string    db 'Available commands:', 0Dh, 0Ah, '  info  - Show hardware information', 0Dh, 0Ah, '  help  - Show this help menu', 0Dh, 0Ah, '  clear - Clear the screen', 0Dh, 0Ah, 0
